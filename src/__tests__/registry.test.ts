...
it("ships a small public language", () => {
  ...
  expect(kinesisRegistryMap.color.ready).toBe(true)
  expect(kinesisRegistryMap.filter.ready).toBe(true)
  expect(kinesisRegistryMap.custom.kind).toBe("response")
  expect(kinesisRegistryMap.press.status).toBe("NEXT")
  expect(kinesisRegistryMap.press.ready).toBe(true)
  expect(kinesisRegistryMap.hold.ready).toBe(true)
  expect(kinesisRegistryMap.press.publicPrimitive).toBe(false)
